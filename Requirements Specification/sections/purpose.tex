...
\begin{itemize}
    ...
    \item When creating a new workspace, the user chooses a name for their new workspace, the sensors that they wish to use and their sampling rate when recording samples and classifying actions.
...
\begin{itemize}
    ...
    \item A single workspace can be shared among several accounts. \textbf{\emph{(?)}}
