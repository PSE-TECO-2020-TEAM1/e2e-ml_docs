...
\begin{enumerate}[{label = \textbf{/F{\protect\twodigits{\arabic{enumi}}}0/}, leftmargin = *}]
    ...
    \item Allow selecting the possible actions on the data on the management panel % can be more specific
...
\begin{enumerate}[resume*]
    ...
    \item Allow creating new labels for the actions to be recorded % before or after recording?
