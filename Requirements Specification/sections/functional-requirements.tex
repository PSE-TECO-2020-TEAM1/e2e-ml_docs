...
\begin{enumerate}[{label = \textbf{/F{\protect\twodigits{\arabic{enumi}}}0/}, leftmargin = *}]
    ...
    \item Visualize the selected data sample as a graph when the data sample is clicked on the workspace panel (line plot, bar plot, box plot, histogram, distplot, heatmaps, 2D and 3D Scatter plot)
