...
\begin{enumerate}[{label = \textbf{/F{\protect\twodigits{\arabic{enumi}}}0/}, leftmargin = *}]
    ...
    \item Allow creating labels for the actions to be recorded
    \item List and edit labels
    \item Display the collected data on the management panel
    \item Allow deleting samples
    \item Enumerate the collected data chronologically on the management panel % maybe add different categories later as optional
...
\begin{enumerate}[resume*]
    ...
    \item Show a recording completed page with an option to go to the configuration page for a new recording% details in a later mockup?
\end{enumerate}
